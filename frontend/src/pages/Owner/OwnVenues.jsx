...
const OwnVenues = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 mt-10 font-serif bg-pink-50 min-h-screen">
      <h2 className="text-3xl font-bold text-center text-pink-700 mb-8 tracking-wide">
        My Wedding Venues
      </h2>
